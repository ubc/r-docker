...
RUN apt update && \
    ...
    Rscript -e 'install.packages(c("leaps", "tree", "glmnet", "lars", "locfit", "nnet", "randomForest", "adabag", "lmerTest", "ggplot2", "visreg", "dplyr", "car", "vegan", "ElemStatLearn", "mclust", "tseries", "zoo", "lpsolve"), repo="http://cran.rstudio.com")'
